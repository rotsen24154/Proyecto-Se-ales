...
%
%      INDEX('Property','Value',...) creates a new INDEX or raises
...
% Last Modified by GUIDE v2.5 05-Jan-2016 11:45:00
...
% --- Executes on button press in decimacion.
function decimacion_Callback(hObject, eventdata, handles)
% hObject    handle to decimacion (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
